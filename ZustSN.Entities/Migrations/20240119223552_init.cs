        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZustIdentityUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Posts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_ZustIdentityUserId",
                        column: x => x.ZustIdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_AspNetUsers_ZustIdentityUserId",
                        column: x => x.ZustIdentityUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_ZustIdentityUserId",
                table: "Messages",
                column: "ZustIdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_ZustIdentityUserId",
                table: "Posts",
                column: "ZustIdentityUserId");
